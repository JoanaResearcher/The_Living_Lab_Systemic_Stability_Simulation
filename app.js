...
const content = {
  en: {
    ...
    heroTitle: "The Living Lab: Systemic Stability Simulation",
    heroSubtitle: "An equity-centered, character-driven housing simulation built for learner-paced reflection.",
    heroNote: "Choose a character first, then guide each day of The 15-Day Stability Roadmap with accessible, informed decisions.",
    ...
    dayDescription: "Follow The 15-Day Stability Roadmap one day at a time.",
    ...
    resultsBody: "The case moved through The 15-Day Stability Roadmap with clearer information, stronger administrative accuracy, and better system alignment.",
    ...
    footer: "Joana Camp | ODU | Lead Technical Researcher",
  ...
  es: {
    eyebrow: "Simulación de Estabilidad Sistémica",
    heroTitle: "The Living Lab: Systemic Stability Simulation",
    heroSubtitle: "Una simulación de vivienda centrada en la equidad, los personajes y el aprendizaje al propio ritmo.",
    heroNote: "Primero elija un personaje y luego acompañe cada día de The 15-Day Stability Roadmap con decisiones accesibles e informadas.",
    languageLabel: "Language / Idioma",
    ...
    dayDescription: "Siga The 15-Day Stability Roadmap un día a la vez.",
    ...
    resultsBody: "El caso avanzó por The 15-Day Stability Roadmap con información más clara, mayor precisión administrativa y mejor alineación del sistema.",
